  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 font-Nunito">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Order Processing Time:</h2>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Shipment Methods:</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Estimated Delivery Time:</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Tracking and Order Status:</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-4">Packaging and Quality Assurance:</h2>
        <ul className="list-disc pl-6">
